 ...
 *
 * @param title - Error title (e.g., "Error Loading Angular Remote")
...
export function createErrorElement(
  ...
  // Only show details in development mode (Webpack environment)
...
// Simple environment detection (always show details for now)
const environment = {
  production: false,
};
