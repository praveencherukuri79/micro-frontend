...
.DESCRIPTION
    ...
    - MF (Module Federation): Kills processes on ports 5000-5007 (React host 5000, Angular host 5007, remotes 5001-5006)
    - WC (Web Components): Kills processes on ports 5010-5011 (React host 5010, Angular host 5011)
...
.PARAMETER Context
    ...
    - "MF" - Module Federation (ports 5000-5007: React host 5000, Angular host 5007, remotes 5001-5006)
    - "WC" - Web Components (ports 5010-5011: React host 5010, Angular host 5011)
...
$MF_REACT_HOST_PORT = 5000
$MF_ANGULAR_HOST_PORT = 5007
$MF_REMOTE_PORTS = @(5001, 5002, 5003, 5004, 5005, 5006)
$WC_REACT_HOST_PORT = 5010
$WC_ANGULAR_HOST_PORT = 5011
...
switch ($Context) {
    "MF" {
        $portsToKill = @($MF_REACT_HOST_PORT, $MF_ANGULAR_HOST_PORT) + $MF_REMOTE_PORTS
        $contextDescription = "Module Federation (ports 5000-5007)"
    }
    "WC" {
        $portsToKill = @($WC_REACT_HOST_PORT, $WC_ANGULAR_HOST_PORT)
        $contextDescription = "Web Components (ports 5010-5011)"
    }
    "All" {
