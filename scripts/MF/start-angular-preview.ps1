<#
.SYNOPSIS
    Build and start Angular MF Host in preview mode

.DESCRIPTION
    Complete workflow for Angular Module Federation preview:
    ...
    Step 6: Start remotes in preview mode + Angular host in dev mode
...
.NOTES
    ...
    For watch mode with auto-rebuild, use: start-angular-watch.ps1
...
Write-Host "Angular MF Host: Build and Preview" -ForegroundColor Cyan
Write-Host "============================================" -ForegroundColor Cyan
Write-Host ""
...
# ===========================================
Write-Host "Step 4/6: Building all remotes..." -ForegroundColor Yellow
Write-Host ""
...
# Build shell web component if not already built
if (-not (Test-Path $shellDistWC)) {
...
# ===========================================
Write-Host "Step 6/6: Starting all applications..." -ForegroundColor Yellow
Write-Host ""
