...
.EXAMPLE
    .\scripts\WC\start-react-preview.ps1
#>
...
Write-Host "React WC Host: Build and Preview" -ForegroundColor Cyan
Write-Host "============================================" -ForegroundColor Cyan
Write-Host ""
...
# STEP 6: Start Host
# ===========================================
Write-Host "Step 6/6: Starting React WC host..." -ForegroundColor Yellow
Write-Host ""

Write-Host "  Starting: host-react-wc on port 5010" -ForegroundColor Green
...
Write-Host ""
Write-Host "============================================" -ForegroundColor Cyan
Write-Host "React WC Host Started Successfully" -ForegroundColor Cyan
Write-Host "============================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "React WC Host (dev mode):" -ForegroundColor Yellow
