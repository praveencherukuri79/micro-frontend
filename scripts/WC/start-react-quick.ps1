<#
.SYNOPSIS
    Quick start React WC Host (no build)

.DESCRIPTION
    Starts React WC Host WITHOUT building or copying.
    Prerequisites:
...
.EXAMPLE
    .\scripts\WC\start-react-quick.ps1
#>
...
Write-Host "React WC Host: Quick Start" -ForegroundColor Cyan
Write-Host "============================================" -ForegroundColor Cyan
Write-Host ""
...
if (-not (Test-Path $widgetsDir)) {
    ...
    Write-Host ""
    Write-Host "Run: .\scripts\WC\start-react-preview.ps1" -ForegroundColor Yellow
    Write-Host ""
    exit 1
}
...
Write-Host ""
Write-Host "============================================" -ForegroundColor Cyan
Write-Host "React WC Host Started" -ForegroundColor Cyan
Write-Host "============================================" -ForegroundColor Cyan
Write-Host ""
