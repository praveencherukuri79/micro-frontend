  ...
  return (
    <Container maxWidth="lg">
      ...
      >
        ...
        <Typography variant="h6" color="text.secondary" paragraph sx={{ maxWidth: 800, mb: 2 }}>
          Web Components Edition
        </Typography>
        <Typography variant="body1" color="text.secondary" paragraph sx={{ maxWidth: 800, mb: 4 }}>
          Experience seamless micro-frontend integration using native Web Components.
          No Module Federation, just pure custom elements!
        </Typography>
